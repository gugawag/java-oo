 ...
 * Não usa herança para poder usar o exemplo antes do aluno ver herança.
 *
...
public class BaralhoSeguro {
  ...
  public BaralhoSeguro() {
    ...
    for(int valor = menorValor(); valor <= maiorValor(); valor++) {
      for(int naipe = primeiroNaipe(); naipe <= últimoNaipe(); naipe++) {
        ...
        // de criaCarta em baralhos de subclasses e criar classes diferentes.
   ...
   * @throws BaralhoVazioException Quando o baralho está vazio.
   */
