 ...
 * Pode-se enviar correio textual, de "missão impossível" ou de áudio.
 *
...
public class CorreioIU3 {
     ...
     */
    public CorreioIU3(String titular) {
     ...
     * <p><strong>missaoimpossivel</strong>: envia uma nova mensagem textual de correio.
     * Como o caso de mensagem de texto  mas a mensagem vai se auto-destruir depois de lida.
    ...
    public void interfaceComUsuário() {
        while(true) {
            ...
            String cmd = Entrada.in.lerLinha("exibir, texto, missaoimpossivel, voz, excluir, +, -, quit? ");
            if(cmd.startsWith("exi")) {
                ...
                String assunto = obtemUmaLinha("Assunto? ");
                String conteúdo = obtemVáriasLinhas("Conteudo da mensagem? (. para terminar) ");
                enviarMensagemMissaoImpossivel(caixa.getTitular(), destinatário, assunto, conteúdo);
    ...
    /**
     * Envia uma mensagem textual de correio eletrônico de Jim para Tom Cruise.
     * @param remetente O remetente da mensagem.
     * @param destinatário O destinatário da mensagem.
     * @param assunto O assunto da mensagem.
     * @param conteúdo O conteúdo da mensagem, podendo conter várias linhas de texto.
     */
    // Observe que este método *não* é public
    private void enviarMensagemMissaoImpossivel(String remetente, String destinatário, String assunto, String conteúdo) {
        CaixaPostal caixaDestino = new CaixaPostal(destinatário);
        caixaDestino.inserir(new MensagemMissaoImpossivel(remetente, assunto, conteúdo));
        caixaDestino.salvar();
    }
    /**
